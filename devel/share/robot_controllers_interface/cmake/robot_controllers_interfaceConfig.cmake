...
if("TRUE" STREQUAL "TRUE")
  set(robot_controllers_interface_SOURCE_PREFIX /media/kruppe/1e0a5b1d-281d-40a6-8ca8-095201d10cc2/Work/columbia/HumanoidRobots/fetch_ws/src/robot_controllers/robot_controllers_interface)
  set(robot_controllers_interface_DEVEL_PREFIX /media/kruppe/1e0a5b1d-281d-40a6-8ca8-095201d10cc2/Work/columbia/HumanoidRobots/fetch_ws/devel)
  ...
  set(robot_controllers_interface_INSTALL_PREFIX /media/kruppe/1e0a5b1d-281d-40a6-8ca8-095201d10cc2/Work/columbia/HumanoidRobots/fetch_ws/install)
...
if(NOT "/media/kruppe/1e0a5b1d-281d-40a6-8ca8-095201d10cc2/Work/columbia/HumanoidRobots/fetch_ws/src/robot_controllers/robot_controllers_interface/include;/usr/include " STREQUAL " ")
  set(robot_controllers_interface_INCLUDE_DIRS "")
  set(_include_dirs "/media/kruppe/1e0a5b1d-281d-40a6-8ca8-095201d10cc2/Work/columbia/HumanoidRobots/fetch_ws/src/robot_controllers/robot_controllers_interface/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_controllers_interface' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_controllers_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/kruppe/1e0a5b1d-281d-40a6-8ca8-095201d10cc2/Work/columbia/HumanoidRobots/fetch_ws/src/robot_controllers/robot_controllers_interface/${idir}'.  Ask the maintainer 'Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
    _list_append_unique(robot_controllers_interface_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "robot_controllers_interface;/usr/lib/i386-linux-gnu/libboost_system.so")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${robot_controllers_interface_dep}_FOUND)
      find_package(${robot_controllers_interface_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${robot_controllers_interface_dep} REQUIRED ${depend_list})
  endif()
